...
def write_to_file(y_test, y_pred_base_dt, y_pred_top_dt, y_pred_base_mlp, y_pred_top_mlp,
    ...
    with open('abalone.txt', 'w') as file:
        ...
        precision_base_dt = metrics.precision_score(y_test, y_pred_base_dt, average="micro")
        recall_base_dt = metrics.recall_score(y_test, y_pred_base_dt, average="micro")
        f1_score_base_dt = metrics.f1_score(y_test, y_pred_base_dt, average="micro")
        ...
        precision_top_dt = metrics.precision_score(y_test, y_pred_top_dt, average="micro")
        recall_top_dt = metrics.recall_score(y_test, y_pred_top_dt, average="micro")
        f1_score_top_dt = metrics.f1_score(y_test, y_pred_top_dt, average="micro")
        ...
        precision_base_mlp = metrics.precision_score(y_test, y_pred_base_mlp, average="micro")
        recall_base_mlp = metrics.recall_score(y_test, y_pred_base_mlp, average="micro")
        f1_score_base_mlp = metrics.f1_score(y_test, y_pred_base_mlp, average="micro")
        ...
        precision_top_mlp = metrics.precision_score(y_test, y_pred_top_mlp, average="micro")
        recall_top_mlp = metrics.recall_score(y_test, y_pred_top_mlp, average="micro")
        f1_score_top_mlp = metrics.f1_score(y_test, y_pred_top_mlp, average="micro")
